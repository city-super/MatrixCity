...
def parse_args():
    ...
    parser.add_argument("--high_name", type=str, default='high/blockdemo')
    parser.add_argument("--road_name", type=str, default='blockdemo_dense_road_fov45')
    parser.add_argument("--out_name", type=str, default='high_road_blockdemo')
