...
- **small_city**: Small City Map ($2.7km^2$) data.
  - **aerial**: Aerial-view data.
    ...
    - **test**:  Test set data.
    - **pose/<block_name>**: Data splits and pose used in our paper. The unit of position is 100m and the rotaton matrix has already been normalized. Please refer to **scripts/generate_split.py** to generate train/test splits for custom block.
