...
#include "MatrixCityPlugin.h"
#include "Engine/RendererSettings.h"
#include "MovieRenderPipelineSettings.h"
#include "CustomMoviePipelineOutput.h"
#include "CustomMoviePipelineDeferredPass.h"

#define LOCTEXT_NAMESPACE "FMatrixCityPluginModule"

void FMatrixCityPluginModule::StartupModule()
{
	// This code will execute after your module is loaded into memory; the exact timing is specified in the .uplugin file per-module
	UE_LOG(LogTemp, Log, TEXT( "MatrixCityPlugin Loaded. Doing initialization." ));
...
void FMatrixCityPluginModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FMatrixCityPluginModule, MatrixCityPlugin)